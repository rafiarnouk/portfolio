    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <motion.div
              className="relative max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white/90 backdrop-blur-md border border-white p-8"
            ...
            >
              ...
              <hr className="border-secondary border-3 mb-4 w-24"></hr>
